    ...
    <div className="flex h-full flex-col md:flex-row">
      ...
      <div className="flex w-full max-w-full grow flex-col overflow-x-hidden bg-[#ffffff] p-6">
        <div className="flex flex-col items-center border-b border-[#000] pb-2">
          <div className="flex w-full items-center justify-between">
            <div className="flex flex-col">
              <h1 className="text-3xl font-black leading-none tracking-tight md:text-2xl">CONTROLE DE ANÁLISES TÉCNICAS</h1>
              <p className="tracking-tight text-gray-500">{analysis?.length || '...'} análises contabilizadas...</p>
            </div>
        ...
        <div className="flex flex-wrap justify-between gap-2 py-2">
          ...
          {isSuccess
            ? analysis.map((analysisInfo) => <TechnicalAnalysisCard analysis={analysisInfo} handleOpenModal={(id) => setEditModal({ id: id, isOpen: true })} />)
            : null}
        </div>
      </div>
