...
function EditPricingUnit({
  ...
  function createPricingUnit() {
    ...
    methodologyArr[index] = pricingHolder
  ...
  return (
    <div className="flex w-[80%] flex-col self-center rounded-md border border-gray-500 p-2 font-Inter">
      <div className="mb-4 flex w-full items-center justify-between">
        <h1 className="font-Inter font-black">EDITAR UNIDADE DE PREÇO</h1>
      </div>
      <input
...
export default EditPricingUnit
