...
type ActiveTechnicalAnalysisProps = {
  analysis: TTechnicalAnalysisDTO
  userHasPricingViewPermission: boolean
}
function ActiveTechnicalAnalysis({ analysis, userHasPricingViewPermission }: ActiveTechnicalAnalysisProps) {
  return (
...
export default ActiveTechnicalAnalysis
