...
import System from '../ProposalStages/disassembly-assembly/System'
import Sizing from '../ProposalStages/disassembly-assembly/Sizing'
import Sale from '../ProposalStages/disassembly-assembly/Sale'
...
import { IProject, IProposalDisassemblyAssemblyInfo, IProposalInfo, ITechnicalAnalysis } from '@/utils/models'
import { checkQueryEnableStatus, useTechnicalAnalysis } from '@/utils/methods'
import { useSession } from 'next-auth/react'

type DisassemblyAssemblyProposalTypes = {
  project: IProject
}
function DisassemblyAssemblyProposal({ project }: DisassemblyAssemblyProposalTypes) {
  ...
  const [proposalInfo, setProposalInfo] = useState<IProposalDisassemblyAssemblyInfo>({
    projeto: {
      nome: project?.nome,
      id: project?._id,
    },
...
export default DisassemblyAssemblyProposal
