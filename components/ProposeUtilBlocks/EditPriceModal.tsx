import { PricesObj, PricesPromoObj, Pricing, getMarginValue, getProposaldPrice, getTaxValue } from '@/utils/pricing/methods'
...
function EditPriceModal({ closeModal, priceType, pricing, setPricing }: EditPriceModalProps) {
          ...
          <div className="flex grow flex-col gap-y-2 overflow-y-auto overscroll-y-auto py-1 scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-300">
            <div className="w-full self-center lg:w-[50%]">
              <NumberInput
                ...
                handleChange={(value) => {
                  const newSellingPrice = getProposaldPrice(value, imposto, margemLucro)
            ...
            <div className="w-full self-center lg:w-[50%]">
              <NumberInput
                ...
                handleChange={(value) => {
                  const newSellingPrice = getProposaldPrice(custo, imposto, value)
            ...
            <div className="w-full self-center lg:w-[50%]">
              <NumberInput
                ...
                handleChange={(value) => {
                  const newSellingPrice = getProposaldPrice(custo, value, margemLucro)
                  setPricing((prev) => ({
                    ...prev,
                    [tag]: {
                      ...prev[tag],
